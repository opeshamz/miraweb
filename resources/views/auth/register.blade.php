                    ...
                    <form method="POST" action="{{ route('register') }}" class="login-form mt-4">
                        ...
                        <div class="form-group position-relative">
                            ...
                            <i data-feather="mail" class="fea icon-sm icons"></i>
                                <input id="email" type="email" class="form-control  pl-5  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">I Accept <a href="https://miraweb.ng/terms_of_service" class="text-primary">Terms And Condition</a></label>
                                </div>
                            </div>
                        </div>
