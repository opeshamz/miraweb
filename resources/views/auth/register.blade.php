                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label for="name" class="col-form-label text-md-right">{{ __('First name') }}
                                            <span class="text-danger">*</span></label>
                                        <i data-feather="user" class="fea icon-sm icons"></i>
                                        <input id="firstname" type="text"
                                               class="form-control pl-5 @error('firstname') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label for="lastname" class="col-form-label text-md-right">{{ __('Last name') }}
                                            <span class="text-danger">*</span></label>
                                        <i data-feather="user" class="fea icon-sm icons"></i>
                                        <input id="lastname" type="text"
                                               class="form-control pl-5 @error('lastname') is-invalid @enderror"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group position-relative">
                                        <label for="email"
                                               class="col-form-label text-md-right">{{ __('E-Mail Address') }} <span
                                                class="text-danger">*</span></label>
                                        <i data-feather="mail" class="fea icon-sm icons"></i>
                                        <input id="email" type="email"
                                               class="form-control  pl-5  @error('email') is-invalid @enderror"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group position-relative">
                                        <label for="password-confirm"
                                               class="col-form-label text-md-right">{{ __('Confirm Password') }} <span
                                                class="text-danger">*</span></label>
                                        <i data-feather="key" class="fea icon-sm icons"></i>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">I Accept <a
                                                    href="https://miraweb.ng/terms_of_service" class="text-primary">Terms
                                ...
                                <div class="mx-auto">
                                    <p class="mb-0 mt-3"><small class="text-dark mr-2">Already have an account ?</small>
                                        <a href="{{url('login')}}" class="text-dark font-weight-bold">Sign in</a></p>
                                </div>
                            </div>
                        </form>
