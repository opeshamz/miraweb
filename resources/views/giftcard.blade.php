...
<div class="gradient-bg title-wrap">
    <div class="row">
        <div class="col-lg-12 col-md-12 whitecolor">
            <h3 class="float-left"> Giftcard</h3>
            <ul class="breadcrumb top10 bottom10 float-right">
            <li class="breadcrumb-item hover-light"><a href="{{url('/')}}">Home</a></li>
                <li class="breadcrumb-item hover-light">giftcard</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="row align-items-center">
    ...
    <div class="image"><img alt="SEO" src="{{asset('images-current/giftss.svg')}}"></div>
    </div>
    <div class="col-lg-5 offset-lg-1 col-md-6 padding_bottom_half text-center text-md-left">
        <h2 class="darkcolor font-normal bottom30">Giftcard Exchange</h2>
        <p class="bottom35 ps"> On here, you can Sell iTunes Gift Cards, Amazon Gift Cards, Walmart Gift Cards, Steam Wallet Gift Cards, Google Play Gift Cards, Target Cards and just any gift cards. <br> <br> Our platform provides customer the opportunity to exchange Giftcards to naira instantly. All payouts are automated and transactions are secured from end-to-end. <br>
        ...
        <div class="text-center text-md-right">
            <div class="feature-item mt-3 wow fadeInLeft" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeft;">
                ...
                <div class="text">
                    ...
                    <p class="ps">Trade your giftcard with high confidence and ease, as we assure you the highest level of encryption and professionally audited exchange system.</p>
                </div>
            </div>
            <div class="feature-item mt-5 wow fadeInLeft" data-wow-delay="350ms" style="visibility: visible; animation-delay: 350ms; animation-name: fadeInLeft;">
                ...
                <div class="text">
                    ...
                    <p class="ps">Exchange your giftcards to naira instantly, We buy Physical Cards, Ecodes. We pay in Naira instantly within 5 minutes.
        ...
        <div class="text-center text-md-left">
            <div class="feature-item mt-3 wow fadeInRight" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRight;">
                ...
                <div class="text">
                    ...
                    <p class="ps"> Our goal is to make life easier for our fellow Nigerians, by making  Our dealings fair and square with the best market rates.</p>
                </div>
            </div>
            <div class="feature-item mt-5 wow fadeInRight" data-wow-delay="350ms" style="visibility: visible; animation-delay: 350ms; animation-name: fadeInRight;">
                ...
                <div class="text">
                    ...
                    <p class="ps">Getting your money as quick as possible is our priority, you are guaranteed to get your payment sent to your account within minutes.</p>
                </div>
            </div>
        </div>
    </div>
