...
// curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json','Authorization:Bearer KN1iEme0Ie2upjoPcsqLq0oPgXdNOZsdMIb69nhL'));
       ...
       $account_name = $user->account->holder_name;
        ...
        $resp = json_decode($result);
           ...
           if($resp->status == "success"){
            ...
            if(($resp->data->first_name == $res[0] || $resp->data->first_name == $res[1] ) && ($resp->data->last_name == $res[0] || $resp->data->last_name == $res[1])){
